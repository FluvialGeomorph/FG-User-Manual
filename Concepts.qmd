...
* _Estimate Initial Channel Extent_ - Use the `REM` to interactively "flood" the channel to make an initial estimate of the detrended bankfull elevation. 
* _Estimate Initial Floodplain Extent_ - Use the `REM` to interactively "flood" the active floodplain to make an initial estimate of the detrended floodplain elevation. 
