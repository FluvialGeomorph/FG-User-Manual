...
8.	Identify Flow Blockages 
    ...
    ::: {layout-ncol=2}
    ![Cutline example 1](images/cutline1.jpg){width=3in}

    ![Cutline example 2](images/cutline2.jpg){width=3in}
    :::
...
::: {.callout-tip}
  Having countywide NHD layer improves processing time if there is more than one site in a county.
