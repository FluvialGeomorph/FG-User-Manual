...
* Use the `16 - XS RAS Watersurface` tool to add a modeled watersurface to the input cross section feature class. 
* Use the `RAS_model_name` to distinguish between multiple RAS model scenarios. 
