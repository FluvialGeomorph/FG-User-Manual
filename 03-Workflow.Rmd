...
* **Task Tracking Spreadsheet:** To guide analysts through this workflow, we have developed a [task tracking spreadsheet](https://tutorial-fluvialgeomorph.s3.us-east-2.amazonaws.com/Task_Tracking.xlsx) to use to record progress through the analysis. This spreadsheet allows an analyst to record the completion of each of the steps outlined above, as well as key values used in the analysis. This spreadsheet can be stored in the site folder while data development progresses. Records in this spreadsheet can be periodically appended to a project or team level version to improve team communication on project progress. 
