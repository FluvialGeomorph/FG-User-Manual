...
* _Develop Candidate Valleylines_ - Through iterative smoothing of the flowline, create a set of candidate valleylines for each reach. 
* _Choose Final Valleyline_ - From the candidate valleylines, choose the one that best captures the overall valley trend line. 
...
* _Derive Bankline Points_ - From the banklines derived in L2, convert to a set of points arranged along the banklines, assign elevations and loop and bend locations. 
