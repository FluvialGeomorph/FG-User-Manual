...
The watershed area metric is calculated by the "XS Watershed Area" tool. Given the complexities of automatically calculating watershed area for high resolution stream features, some watershed areas may not have been calculated correctly. Rerunning the tool or manual adjustment may be required. Be sure to edit the "Watershed_Area_Sq
...
Sinuosity vlues should be greater than one. 
