...
### Define Study Area Reaches
### Use the NHDPlus Flow accumulation to identify major changes in drainage area
...
#### Build a DEM from LiDAR point cloud data for each reach
#### Verify that the DEM elevations are in feet
#### Create a hillshade to improve visualization
