...
* Create a new polygon feature class named [`study_area`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#study-area-fc). 
* This polygon should outline the extent of the study reaches. 
* If the study reaches are already known, sub divide the [`study_area`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#study-area-fc) polygon into these study reaches. 
...
* Use the [`07 - Detrend`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#detrend-dem-tool) tool to create a detrended DEM for the study reach. Set the `buffer_distance` field to a distance wide enough to capture the reach's entire active floodplain.  
...
* Use the ERSI `Clip Raster` tool to clip the [`watershed_contributing_area`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#contributing-area-raster) raster to `stream_network_buffer` to speed tool run time. 
...
* This tool creates a new feature class named [`<cross section FC name>_points`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#xs-points-fc). 
...
* Create a new point FC named [`features`](https://www.techmanual.fluvialgeomorph.org/toolbox.html#features-fc) containing the following fields:
